const shadows = {
  ...
  "xs-dark": "0px 1px 3px rgba(11, 12, 17, 0.6)",
  "sm-dark": "0px 2px 4px rgba(11, 12, 17, 0.6)",
  "md-dark": "0px 4px 8px rgba(11, 12, 17, 0.6)",
  "lg-dark": "0px 8px 16px rgba(11, 12, 17, 0.6)",
  "xl-dark": "0px 16px 24px rgba(11, 12, 17, 0.6)",
};
